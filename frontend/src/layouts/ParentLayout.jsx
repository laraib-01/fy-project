...
const ParentLayout = ({ children }) => {
  ...
  const sidebarItems = [
    { name: "Dashboard", icon: "lucide:layout-dashboard", path: "/parent" },
    { name: "Children", icon: "lucide:users", path: "/parent/children" },
    {
      name: "Attendance",
      icon: "lucide:calendar-check",
      path: "/parent/attendance",
    },
    { name: "Grades", icon: "lucide:award", path: "/parent/grades" },
    {
      name: "Assignments",
      icon: "lucide:file-text",
      path: "/parent/assignments",
    },
    { name: "Events", icon: "lucide:calendar", path: "/parent/events" },
    {
      name: "Messages",
    ...
    { name: "Payments", icon: "lucide:credit-card", path: "/parent/payments" },
  ];
              ...
              <DropdownTrigger>
                <Button variant="light" className="flex items-center gap-2">
                  <Avatar
                    name="Farooq Khan"
                    size="sm"
                    src="https://img.heroui.chat/image/avatar?w=200&h=200&u=parent"
                  />
                  {isSidebarOpen ? null : <span>Farooq Khan</span>}
                </Button>
              </DropdownTrigger>
