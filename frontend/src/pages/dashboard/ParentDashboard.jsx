            ...
            {children.map((child) => (
              <DropdownItem key={child.id} textValue={child.name}>
                <div className="flex items-center gap-2">
                  ...
                  <div>
                    <p>{child.name}</p>
                    <p className="text-foreground-500 text-xs">{child.grade}</p>
                  </div>
                </div>
              </DropdownItem>
            ))}
                  ...
                  <div className="flex-grow">
                    ...
                    <div className="flex flex-wrap gap-4 mt-2">
                      <div>
                        ...
                        <p className="font-medium">{selectedChildData.grade}</p>
                      </div>
                      <div>
                        <p className="text-foreground-500 text-sm">Class</p>
                        <p className="font-medium">{selectedChildData.class}</p>
                      </div>
                      <div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                ...
                <CardBody>
                  ...
                  <div className="mt-4">
                    <div className="flex justify-between text-sm mb-1">
                      ...
                      <span>Absent: {currentMonthAttendance.absent} days</span>
              ...
              <Card>
                <CardBody>
                  <div className="flex justify-between items-start">
                    <div>
                      <p className="text-foreground-500">Pending Assignments</p>
          ...
          {selectedTab === "assignments" && (
            <div className="space-y-6">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                <Card>
                  <CardBody>
                    <h4 className="font-semibold mb-4">Upcoming Assignments</h4>
                    <div className="space-y-4">
                      {assignments
                  ...
                  <div className="flex justify-between items-center mb-4">
                    ...
                    <Dropdown>
                      ...
                      <DropdownMenu aria-label="Announcement filter">
                        <DropdownItem key="all">All Announcements</DropdownItem>
                        <DropdownItem key="class">Class Specific</DropdownItem>
